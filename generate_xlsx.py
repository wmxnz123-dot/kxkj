...
data = [
    ...
    ["数据检索管理", "数图分析/社区地图", "3D人口态势大屏", "以GIS/3D地图宏观展示人口分布热力图，包含不同年龄段人口占比、性别分布情况、民族分布情况、人口增长状况等。", "Admin端", "管理员权限"],
    ["数据检索管理", "数图分析/社区地图", "AI态势预测与推演", "【AI结合】结合历史人口迁徙、出生率、社保缴纳等数据，利用机器学习算法预测未来3-5年的趋势。", "Admin端", "管理员权限"],
